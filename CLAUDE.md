...
7. `references/used-keywords.md` — check before picking any primary keyword; **3 known semantic-cannibalization clusters already exist covering ~25 of the 100 published posts** ("best/top pipe company," "best pipe for plumbing," "which pipe is best") — don't add to them
8. `on-page-seo-ajaypipes.md` — real, verified platform findings (schema gaps, stale sitemap, live cannibalization URLs) that the engine's generic checklist doesn't know about
...
- 100 blog posts published Sept 2024–Jun 2026, 100% classified informational, ~25 of them are near-duplicate "best pipe company/brand" intent
